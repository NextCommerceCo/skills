...
| [**Bulk Subscription Actions**](next-bulk-subscription/) | Pause, cancel, or PATCH subscription fields for a list of subscription IDs | Merchant wants to bulk-pause indefinitely or until a date, bulk-shift renewals, bulk-cancel, or migrate subscriptions between gateways |
