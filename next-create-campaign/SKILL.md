...
| checkout `calculate` rows off by exactly the shipping price | the live free-shipping offer's condition or scope does not match the plan | check the offer in the dashboard; the plan's condition is what verify expects |
